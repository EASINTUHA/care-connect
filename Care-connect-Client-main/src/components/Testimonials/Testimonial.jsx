  ...
  const reviews = [
    {
      ...
      rating: 4.2,
      details:
        "Exceptional care, compassionate staff—my best healthcare experience. Highly recommend this hospital.",
    },
    {
      _id: "2",
      name: "Rahyan Shamsi",
      ...
      rating: 3.5,
      details:
        "Outstanding service, skilled professionals. Grateful for the excellent care. Top-notch facility.",
    },
    {
      _id: "3",
      name: "MD Easin",
      ...
      rating: 4,
      details:
        "Superb medical team, efficient service. A truly positive and healing environment. Highly satisfied.",
    },
    {
      _id: "4",
      name: "MD Eyakub",
      ...
      rating: 3.7,
      details:
        "Remarkable hospital—exemplary care, cutting-edge facilities. A beacon of health and wellness.",
    },
    {
      _id: "5",
      name: "Al Mahmud",
      ...
      rating: 4.7,
      details:
        "Impressed by the expertise and kindness. Exceptional healthcare that exceeds expectations. Highly recommended.",
    },
  ];
